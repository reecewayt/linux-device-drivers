#ifndef MY_E1000_DRV_TIMER_H
#define MY_E1000_DRV_TIMER_H
...
#define DEVICE_NAME "my-e1000-drv-timer"
...
#define DEFAULT_BLINK_RATE 2 //2 blinks per second, freq = 1/2 = 0.5 Hz
#define DEFAULT_DUTY_CYCLE 0.50 //50% duty cycles
...
#define E1000_LEDCTL_MODE_ALL_LED_OFF 0x0F0F0F0F 
...
struct my_device {
    ...
    struct timer_list blink_timer;  // Timer for blinking LED
    unsigned int open_count;        // Counts number of processes with driver open
};
